import GPUtil #Download with pip
import os
import tensorflow as tf

#Calls to this function MUST be placed in the  
#          if __name__ == '__main__': 
#section (mandatory if using absl to run main()),
# or after imports, or env variables will be ignored
# Call like: 
# import gpu
# runDistributed = True
# ...
